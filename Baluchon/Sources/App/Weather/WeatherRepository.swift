...
final class WeatherRepository: WeatherRepositoryType {
    ...
    func getWeather(callback: @escaping (Weather) -> Void, error: @escaping (() -> Void)) {
        let stringUrl = "http://api.openweathermap.org/data/2.5/group?id=2988507,5128581,2996944,2996944,2990969,3031582,2972315,,5368361,5391811,4887398,4440906,5308655&units=metric&appid=916792210f24330ed8b2f3f603669f4d"
