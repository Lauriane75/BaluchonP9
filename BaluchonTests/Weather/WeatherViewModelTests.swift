...
//        let viewModel = WeatherViewModel(delegate: nil)
//        let expectation = self.expectation(description: "Returned weather")
//
...
//        let viewModel = WeatherViewModel(delegate: mockDelegate)
//
//        viewModel.viewDidLoad()
//
